...
var g=this,k=!1;return{resolve:h(this.K),reject:h(this.l)}};
b.prototype.K=function(h){if(h===this)this.l(new TypeError("A Promise cannot resolve to itself"));else if(h instanceof b)this.M(h);else{a:switch(typeof h){case "object":var g=h!=null;break a;case "function":g=!0;break a;default:g=!1}g?this.J(h):this.m(h)}};
b.prototype.J=function(h){var g=void 0;try{g=h.then}catch(k){this.l(k);return}typeof g=="function"?this.N(g,h):this.m(h)};
b.prototype.l=function(h){this.A(2,h)};
b.prototype.m=function(h){this.A(1,h)};
b.prototype.A=function(h,g){if(this.h!=0)throw Error("Cannot settle("+h+", "+g+"): Promise already settled in state"+this.h);this.h=h;this.i=g;this.h===2&&this.L();this.C()};
b.prototype.L=function(){var h=this;f(function(){if(h.I()){var g=q.console;typeof g!=="undefined"&&g.error(h.i)}},1)};
b.prototype.I=function(){if(this.o)return!1;var h=q.CustomEvent,g=q.Event,k=q.dispatchEvent;if(typeof k==="undefined")return!0;typeof h==="function"?h=new h("unhandledrejection",{cancelable:!0}):typeof g==="function"?h=new g("unhandledrejection",{cancelable:!0}):(h=q.document.createEvent("CustomEvent"),h.initCustomEvent("unhandledrejection",!1,!0,h));h.promise=this;h.reason=this.i;return k(h)};
b.prototype.C=function(){if(this.g!=null){for(var h=0;h<this.g.length;++h)e.h(this.g[h]);this.g=null}};
var e=new c;b.prototype.M=function(h){var g=this.j();h.B(g.resolve,g.reject)};
b.prototype.N=function(h,g){var k=this.j();try{h.call(g,k.resolve,k.reject)}catch(l){k.reject(l)}};
...
J.prototype.D=function(){if(this.j)for(;this.j.length;)this.j.shift()()};function Ka(a){var b={},c;for(c in a)b[c]=a[c];return b}
...
var Sa=new K("about:invalid#zClosurez");function Ta(a){this.S=a}
...
;function T(a){J.call(this);this.o=1;this.l=[];this.m=0;this.g=[];this.h={};this.A=!!a}
...
function ib(a,b,c){var d=U;if(a=d.h[a]){var f=d.g;(a=a.find(function(e){return f[e+1]==b&&f[e+2]==c}))&&d.F(a)}}
n.F=function(a){var b=this.g[a];if(b){var c=this.h[b];this.m!=0?(this.l.push(a),this.g[a+1]=function(){}):(c&&wa(c,a),delete this.g[a],delete this.g[a+1],delete this.g[a+2])}return!!b};
n.G=function(a,b){var c=this.h[a];if(c){var d=Array(arguments.length-1),f=arguments.length,e;for(e=1;e<f;e++)d[e-1]=arguments[e];if(this.A)for(e=0;e<c.length;e++)f=c[e],jb(this.g[f+1],this.g[f+2],d);else{this.m++;try{for(e=0,f=c.length;e<f&&!this.i;e++){var h=c[e];this.g[h+1].apply(this.g[h+2],d)}}finally{if(this.m--,this.l.length>0&&this.m==0)for(;c=this.l.pop();)this.F(c)}}return e!=0}return!1};
...
n.D=function(){T.H.D.call(this);this.clear();this.l.length=0};var kb=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function lb(a){var b=a.match(kb);a=b[1];var c=b[2],d=b[3];b=b[4];var f="";a&&(f+=a+":");d&&(f+="//",c&&(f+=c+"@"),f+=d,b&&(f+=":"+b));return f}
...
;var W=window;
function X(a,b){this.v={};this.playerInfo={};this.videoTitle="";this.i=this.g=null;this.h=0;this.m=!1;this.l=[];this.j=null;this.C={};this.options=null;this.A=this.T.bind(this);if(!a)throw Error("YouTube player element ID required.");this.id=qa(this);b=Object.assign({title:"video player",videoId:"",width:640,height:360},b||{});var c=document;if(a=typeof a==="string"?c.getElementById(a):a){W.yt_embedsEnableRsaforFromIframeApi&&rb();c=a.tagName.toLowerCase()==="iframe";b.host||(b.host=c?lb(a.src):"https://www.youtube.com");
this.options=b||{};b=[this.options,window.YTConfig||{}];for(var d=0;d<b.length;d++)b[d].host&&(b[d].host=b[d].host.toString().replace("http://","https://"));c||(W.yt_embedsEnableAutoplayAndVisibilitySignals?(b=document.createElement("iframe"),zb(this,b,a),this.i=a,hb(b,a),Ab(this,b,Bb(this,b)),a=b):(b=document.createElement("iframe"),zb(this,b,a),Ab(this,b,Bb(this)),this.i=a,hb(b,a),a=b));this.g=a;this.g.id||(this.g.id="widget"+qa(this.g));V[this.g.id]=this;if(window.postMessage){this.j=new T;Cb(this);
a=Y(this,"events");for(var f in a)a.hasOwnProperty(f)&&this.addEventListener(f,a[f]);for(var e in tb)tb.hasOwnProperty(e)&&Db(this,e)}}}
...
n.T=function(){Hb(this)||clearInterval(this.h)};
function Hb(a){if(!a.g||!a.g.contentWindow)return!1;a.sendMessage({event:"listening"});return!0}
function Cb(a){Ib(a,a.id,String(Y(a,"host")));a.h=setInterval(a.A,250);a.g&&(a.o=function(){clearInterval(a.h);a.h=setInterval(a.A,250)},a.g.addEventListener("load",a.o))}
function Jb(a){var b=a.getBoundingClientRect();a=Math.max(0,Math.min(b.bottom,window.innerHeight||document.documentElement.clientHeight)-Math.max(b.top,0))*Math.max(0,Math.min(b.right,window.innerWidth||document.documentElement.clientWidth)-Math.max(b.left,0));a=(b=b.height*b.width)?a/b:0;return document.visibilityState==="hidden"||a<.5?1:a<.75?2:a<.85?3:a<.95?4:a<1?5:6}
function Eb(a,b){a.C[b]||(a.C[b]=!0,Fb(a,"addEventListener",[b]))}
...
function Gb(a){if((a=String(Y(a,"videoId")))&&(a.length!==11||!a.match(/^[a-zA-Z0-9\-_]+$/)))throw Error("Invalid video id");return"/embed/"+a}
...
W.yt_embedsEnableIframeApiSendFullEmbedUrl&&(window.location.href&&(c.forigin=window.location.href),a=window.location.ancestorOrigins,c.aoriginsup=a===void 0?0:1,a&&a.length>0&&(c.aorigins=Array.from(a).join(",")),window.document.referrer&&(c.gporigin=window.document.referrer));W.yt_embedsEnableAutoplayAndVisibilitySignals&&b&&(c.vf=Jb(b));return c}
function Kb(a,b){if(H(b)){for(var c in b)b.hasOwnProperty(c)&&(a.playerInfo[c]=b[c]);a.playerInfo.hasOwnProperty("videoData")&&(b=a.playerInfo.videoData,b.hasOwnProperty("title")&&b.title?(b=b.title,b!==a.videoTitle&&(a.videoTitle=b,a.g.setAttribute("title",b))):(a.videoTitle="",a.g.setAttribute("title","YouTube "+Y(a,"title"))))}}
function Lb(a,b){b=x(b);for(var c=b.next(),d={};!c.done;d={u:void 0},c=b.next())d.u=c.value,a[d.u]||(d.u==="getCurrentTime"?a[d.u]=function(){var f=this.playerInfo.currentTime;if(this.playerInfo.playerState===1){var e=(Date.now()/1E3-this.playerInfo.currentTimeLastUpdated_)*this.playerInfo.playbackRate;e>0&&(f+=Math.min(e,1))}return f}:xb(d.u)?a[d.u]=function(f){return function(){this.playerInfo={};
...
var Z=null,Mb=null;function Nb(a){if(a.tagName.toLowerCase()!=="iframe"){var b=vb(a,"videoid");b&&(b={videoId:b,width:vb(a,"width"),height:vb(a,"height")},new X(a,b))}}
function Ib(a,b,c){Z||(Z={},Mb=new Set,Ob.addEventListener("message",function(d){a:if(Mb.has(d.origin)){try{var f=JSON.parse(d.data)}catch(g){break a}var e=Z[f.id];if(e&&d.origin===e.O)switch(d=e.U,d.m=!0,d.m&&(va(d.l,d.sendMessage,d),d.l.length=0),e=f.event,f=f.info,e){case "apiInfoDelivery":if(H(f))for(var h in f)f.hasOwnProperty(h)&&(d.v[h]=f[h]);break;case "infoDelivery":Kb(d,f);break;case "initialDelivery":H(f)&&(clearInterval(d.h),d.playerInfo={},d.v={},Lb(d,f.apiInterface),Kb(d,f));break;case "alreadyInitialized":clearInterval(d.h);
break;case "readyToListen":Hb(d);break;default:d.j.i||(h={target:d,data:f},d.j.G(e,h),wb("player."+e,h))}}}));
Z[b]={U:a,O:c};Mb.add(c)}
var Ob=window;I("YT.PlayerState.UNSTARTED",-1);I("YT.PlayerState.ENDED",0);I("YT.PlayerState.PLAYING",1);I("YT.PlayerState.PAUSED",2);I("YT.PlayerState.BUFFERING",3);I("YT.PlayerState.CUED",5);I("YT.get",function(a){return V[a]});
...
I("YT.Player",X);X.prototype.destroy=X.prototype.destroy;X.prototype.setSize=X.prototype.setSize;X.prototype.getIframe=X.prototype.getIframe;X.prototype.addEventListener=X.prototype.addEventListener;X.prototype.getVideoEmbedCode=X.prototype.getVideoEmbedCode;X.prototype.getOptions=X.prototype.getOptions;X.prototype.getOption=X.prototype.getOption;sb.push(function(a){var b=a;b||(b=document);a=ya(b.getElementsByTagName("yt:player"));b=ya((b||document).querySelectorAll(".yt-player"));va(xa(a,b),Nb)});
typeof YTConfig!=="undefined"&&YTConfig.parsetags&&YTConfig.parsetags!=="onload"||ub();var Pb=G.onYTReady;Pb&&Pb();var Qb=G.onYouTubeIframeAPIReady;Qb&&Qb();var Rb=G.onYouTubePlayerAPIReady;Rb&&Rb();}).call(this);